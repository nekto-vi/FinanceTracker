...
* **Недельный график (Profit Chart):** Столбчатая диаграмма распределения трат по дням недели с цветовой маркировкой категорий.
...
* Готовые базовые категории с эмодзи и акцентными цветами.
